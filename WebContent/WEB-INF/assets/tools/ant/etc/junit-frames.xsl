...
<xsl:param name="TITLE">Unit EmbeddedJetty Results.</xsl:param>
...
<xsl:template match="testsuites" mode="all.tests">
	...
	<head>
	    <title>Unit EmbeddedJetty Results: <xsl:value-of select="$title"/></title>
...
<xsl:template match="testsuite" mode="class.details">
    ...
    <html>
        <head>
          <title>Unit EmbeddedJetty Results: <xsl:value-of select="$class.name"/></title>
            <xsl:call-template name="create.stylesheet.link">
...
<xsl:template name="classes.list">
    ...
    <html>
        <head>
            <title>Unit EmbeddedJetty Classes: <xsl:value-of select="$name"/></title>
            <xsl:call-template name="create.stylesheet.link">
...
<xsl:template match="testsuites" mode="all.classes">
    <html>
        <head>
            <title>All Unit EmbeddedJetty Classes</title>
            <xsl:call-template name="create.stylesheet.link">
                <xsl:with-param name="package.name"/>
            </xsl:call-template>
        </head>
...
<xsl:template match="testsuites" mode="all.packages">
    <html>
        <head>
            <title>All Unit EmbeddedJetty Packages</title>
            <xsl:call-template name="create.stylesheet.link">
                <xsl:with-param name="package.name"/>
            </xsl:call-template>
        </head>
...
<xsl:template match="testsuites" mode="overview.packages">
    <html>
        <head>
            <title>Unit EmbeddedJetty Results: Summary</title>
            <xsl:call-template name="create.stylesheet.link">
                <xsl:with-param name="package.name"/>
            </xsl:call-template>
        </head>
